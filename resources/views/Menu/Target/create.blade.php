            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        <form action="/menu/target" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="kode_target" id="kode_target" type="text" class="@error('kode_target') is-invalid @enderror form-control" aria-describedby="kode_target"/>
